...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        {
          response = "Ah! I've heard of them, they sound very nice.";
        }
        else if (statement.trim().length() == 0)
        {
          response = "... Did you say something?";
        }
        else if (findKeyword(statement,"rocket") >= 0)
        {
          response = "Blast off!";
        }
        else if (findKeyword(statement,"computer") >= 0)
        {
          response = "Hmm... Are you talking about me?";
        }
        else if (findKeyword(statement,"science") >= 0)
        {
          response = "My creators are good at science!";
        }
        else
        {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "One second... Ok, I'm back.";
        }
        return response;
    }

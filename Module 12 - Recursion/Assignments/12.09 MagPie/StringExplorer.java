...
public class StringExplorer
{
    ...
    public static void main(String[] args)
    {
        ...
        sample = "  The answer to life is 42 young one.  ";
        ...
        System.out.println("sample.indexOf(\"one\") = " + sample.indexOf("one"));
        System.out.println("sample.indexOf('e', 12) = " + sample.indexOf('e', 12));
        //    substring() with one and two parameters
        System.out.println("sample.substring(6) = " + sample.substring(6));
        System.out.println("sample.substring(6, 12) = " + sample.substring(6, 12));
        //    compareTo()
        System.out.println("sample.compareTo(\"The answer to life is 43 old one\") = " + sample.compareTo("The answer to life is 43 old one"));

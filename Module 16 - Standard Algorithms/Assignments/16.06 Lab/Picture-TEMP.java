...
public class Picture extends SimplePicture
{
  ...
  {
    Picture img1 = new Picture("caterpillar.jpg");
    img1.mirrorHorizontalBotToTop();
    this.copy(img1,0,0);
    this.copy(img1,100,0);
    this.copy(img1,200,0);
    Picture img2 = new Picture("robot.jpg");
    img2.negate();
    this.copy(img2,300,0);
    this.copy(img2,400,0);
    this.copy(img2,500,0);
    this.grayscale();
    this.write("collage.jpg");
  }
